[![Run App KevinAkerberg](https://github.com/kakerberg/GithubActionsAkerberg/actions/workflows/run-app.yaml/badge.svg)](https://github.com/kakerberg/GithubActionsAkerberg/actions/workflows/run-app.yaml)
